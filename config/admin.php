...
return [
    ...
    */
    ...
    |
    */
    'logo' => '<img src="'.env('APP_URL').'/images/logo.png" width="35"> &nbsp;ATCMS5',
    ...
    |
    */
    'logo-mini' => '<img src="'.env('APP_URL').'/images/logo.png">',
    ...
    |
    */
    'favicon' => env('APP_URL').'/images/logo.ico',
    ...
    /*
     ...
     |
     */
    'default_avatar' => env('APP_URL').'/images/default-avatar.jpg',
    ...
    */
    'route' => [
        ...
        'prefix' => env('ADMIN_ROUTE_PREFIX', 'atadmin'),
